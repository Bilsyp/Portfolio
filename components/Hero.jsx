    ...
    <section className="text-center my-15 p-8 hero md:flex md:text-left justify-between items-center">
      <div className="sm:max-w-md mx-auto md:max-w-xl">
        <h1 className="text-5xl  lg:text-6xl font-bold">
          <span className="bg-gradient-to-r from-cyan-500 to-slate-700 bg-clip-text text-transparent">
            Bilal Syahputra{" "}
          </span>
          <br />
        </h1>
        <h2 className="text-md py-3 font-semibold text-gray-700 lg:text-2xl md:text-xl">
        ...
        <p className="text-md md:text-xl lg:text-2xl text-gray-500 py-4 leading-8 ">
          ...
          HTML, Javascript, and Jquery as well as skills in Object Oriented
          Programming. I am a fresh graduate and am ready to learn.
        </p>
        <div className="flex justify-center items-center gap-10 md:justify-start my-10">
